        ...
        <footer className="bg-gradient-to-r from-red-900 to-red-800 text-white py-8 sm:py-12 safe-area-inset-bottom">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              {/* Redes Sociais */}
              <div className="mb-6">
                <h3 className="text-lg font-semibold mb-4 text-amber-200">Siga-nos nas Redes Sociais</h3>
                <div className="flex items-center justify-center gap-6">
                  ...
                  <a
                    ...
                    className="group flex items-center justify-center w-12 h-12 bg-white/10 hover:bg-blue-600 rounded-full transition-all duration-300 hover:scale-110"
                    title="Facebook"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group flex items-center justify-center w-12 h-12 bg-white/10 hover:bg-gradient-to-r hover:from-purple-500 hover:to-pink-500 rounded-full transition-all duration-300 hover:scale-110"
                    title="Instagram"
                  >
                    <svg className="w-6 h-6 text-white group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  {/* WhatsApp */}
                  <a
                    href="https://wa.me/5511985888816"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group flex items-center justify-center w-12 h-12 bg-white/10 hover:bg-green-500 rounded-full transition-all duration-300 hover:scale-110"
                    title="WhatsApp"
                  >
                    <svg className="w-6 h-6 text-white group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
